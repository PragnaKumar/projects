...
def play_stored_video(conf, model):
    ...
    if st.sidebar.button('Segment Video Objects'):
        try:
            ...
            while (vid_cap.isOpened()):
                ...
                if success:
                    ...
                    #st.sidebar.text(f"Total number of persons:{len(counterin)}")
                else:
                    vid_cap.release()
                    break
        except Exception as e:
...
def main():
    ...
    st.sidebar.header("Video/Webcam Config")
